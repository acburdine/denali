...
export default abstract class Serializer extends View {
    ...
    render(action: Action, response: ServerResponse, body: any, options: RenderOptions): Promise<void>;
    protected abstract serialize(action: Action, body: any, options: RenderOptions): Promise<any>;
}
